...
//		});
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		super.onClick(v);
		if(v == cleanHistroy_RL) {
			DialogUtil.showTip2Dialog(this, "确定要清除历史？", new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					
					if(HistroyUserPreferences.getInstance(SetAdminActivity.this).clearAllHistoryUser()) {
						DialogUtil.dismissDialog();
						Toast.makeText(SetAdminActivity.this, "成功清除历史", Toast.LENGTH_SHORT).show();
					}
				}
			});
		}
		if(v == about_RL) {
			Intent intent = new Intent(SetAdminActivity.this, AboutActivity.class);
...
//			// TODO Auto-generated method stub
//			super.onPreExecute();
//			pDialog = UserFunctions.createProgressDialog(SetAdminActivity.this,
//					"后台忙碌中，请稍后...");
//		}
//
//		@Override
