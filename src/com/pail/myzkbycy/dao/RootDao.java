...
public class RootDao {
	...
	public RootDao(Context _context) {
	 ...
	 * @return
	 */
	public long deleteOneData(String DB_TABLE, String key, Object id) {//long id
		return db.delete(DB_TABLE, key + "="  +"'"+id+"'", null);
	}

	public long updateOneData(String DB_TABLE , String key, Object id, Object object) {//long id
		ContentValues updateValues = new ContentValues();

		fillContentValuse(object, updateValues,null);

		return db.update(DB_TABLE, updateValues, key + "=" + "'" + id + "'", null);//key + "=" + id
	}
